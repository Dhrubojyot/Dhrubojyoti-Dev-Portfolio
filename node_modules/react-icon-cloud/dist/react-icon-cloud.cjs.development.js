...
var CloudWrapped = function CloudWrapped(_ref) {
  ...
  return React.createElement(UseInViewport, {
    cb: onVisibilityChange
  }, React.createElement("div", Object.assign({
    id: state.canvasContainerId
  }, containerProps), React.createElement("canvas", Object.assign({
    id: state.canvasId,
    style: {
      width: '100%',
      maxWidth: '70vh'
...
var Cloud = function Cloud(props) {
  return React.createElement(CloudWrapped, Object.assign({}, props, {
    key: guid()
  }));
};
...
var renderSimpleIcon = function renderSimpleIcon(_ref) {
  ...
  var isAccessibleColor = convertColors.hex2contrast(bgHexHash, originalHex) > minContrastRatio;
  var rgb = isAccessibleColor ? convertColors.hex2rgb(originalHex) : convertColors.hex2rgb(fallbackHexHash);
  ...
  return React.createElement("a", Object.assign({}, a), React.createElement("img", Object.assign({}, i)));
};
...
exports.Cloud = Cloud;
exports.fetchSimpleIcons = fetchSimpleIcons;
exports.getSlug = getSlug;
exports.renderSimpleIcon = renderSimpleIcon;
