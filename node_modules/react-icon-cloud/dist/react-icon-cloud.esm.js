...
var renderSimpleIcon = function renderSimpleIcon(_ref) {
  ...
  var isAccessibleColor = hex2contrast(bgHexHash, originalHex) > minContrastRatio;
  var rgb = isAccessibleColor ? hex2rgb(originalHex) : hex2rgb(fallbackHexHash);
...
export { Cloud, fetchSimpleIcons, getSlug, renderSimpleIcon };
