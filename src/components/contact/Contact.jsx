...
const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_m28qni5', 'template_9qiutoh', formRef.current, {
        publicKey: '3wXeBgGpepyK1VVjO',
      })
      .then(
        (result) => {
            setSuccess(true);
...
<h2>E-Mail</h2>
<span>dhrubojyotichakraborty69@gmail.com</span>
</motion.div>
<motion.div className="item" variants={variants}>
<h2>Address</h2>
<span>Mogra,  Hooghly,  West Bengal,  PIN-712148</span>
</motion.div>
<motion.div className="item" variants={variants}>
<h2>Phone</h2>
<span>91+ 9330857191</span>
</motion.div> 
</motion.div>
